        ...
        if(mBleRangingHelper != null) {
            if (TrxUtils.createLogFile()) {
                ...
                TrxUtils.appendSettingLogs(connectedCarType,
                        ...
                        SdkPreferencesHelper.getInstance().getIndoorRatioMaxMinThreshold(connectedCarType),
                        SdkPreferencesHelper.getInstance().getIndoorRatioCloseToCarThreshold(connectedCarType),
                        SdkPreferencesHelper.getInstance().getOutsideRatioMaxMinThreshold(connectedCarType),
