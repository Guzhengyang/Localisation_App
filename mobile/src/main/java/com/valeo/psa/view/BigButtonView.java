...
public class BigButtonView extends FrameLayout {
    ...
    public BigButtonView(Context context, AttributeSet attrs) {
        ...
        text.setTextSize(resources.getDimension(R.dimen.default_big_button_text_size));
        ...
        subText.setTextSize(resources.getDimension(R.dimen.default_big_button_sub_text_size));
