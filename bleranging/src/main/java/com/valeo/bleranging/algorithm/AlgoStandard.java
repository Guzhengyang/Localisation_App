...
public class AlgoStandard implements SensorEventListener {
    ...
    public AlgoStandard(Context mContext, InblueProtocolManager mProtocolManager,
                        RKEManager mRKEManager, Handler mainHandler) {
    ...
    private void setIsBackValid() {
        if (isUnlockStrategyValid != null) {
            if (isUnlockStrategyValid.contains(PREDICTION_BACK)) {
