        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_DATA_AVAILABLE.equals(action)) {
                ...
                if (bytesReceived != null) {
                    ...
                    final int receivedTrxNumber = bytesReceived[3] & 0xF0;
                    final int receivedChannelNumber = bytesReceived[3] & 0x0F;
                    ...
                    connectedCar.saveCarRssi(receivedTrxNumber, bytesReceived[4], receivedChannel);
                    lock.readLock().unlock();
                }
