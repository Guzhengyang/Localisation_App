    ...
    private final Runnable updateCarLocalizationRunnable = new Runnable() {
        ...
        public void run() {
            if (SdkPreferencesHelper.getInstance().getSelectedAlgo().equalsIgnoreCase(ALGO_STANDARD)) {
                mAlgoManager.tryStandardStrategies(newLockStatus, isFullyConnected(),
            ...
            updateCarLocalization(mAlgoManager.getPredictionPosition(), mAlgoManager.getPredictionProximity());
