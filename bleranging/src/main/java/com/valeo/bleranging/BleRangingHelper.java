...
public class BleRangingHelper {
    public static final String PREDICTION_START_FL = "start_fl";
    public static final String PREDICTION_START_FR = "start_fr";
    public static final String PREDICTION_START_RL = "start_rl";
    public static final String PREDICTION_START_RR = "start_rr";
